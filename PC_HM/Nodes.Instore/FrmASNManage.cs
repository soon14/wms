...
{
    public partial class FrmASNManage : DevExpress.XtraEditors.XtraForm, IAsnManage
    {
            ...
            string inboundType, DateTime dateFrom, DateTime dateTo)
        {
            ...
            else
            {
                displayContent = string.Format(@"查询条件: {0}{1}{2}{3}{4}{5}{6}",
                    ...
                    string.IsNullOrEmpty(billType) ? "" : "单据类型=" + listAsnType.Text + separator,
                    string.IsNullOrEmpty(billStatus) ? "" : "单据状态=" + listAsnState.Text + separator,
                    string.IsNullOrEmpty(inboundType) ? "" : "收货方式=" + listInstoreType.Text + separator,
        ...
        private void QueryCustom()
        {
            ...
            string billType = ConvertUtil.ToString(listAsnType.EditValue);
            string billState = ConvertUtil.ToString(listAsnState.EditValue);
            string inboundType = ConvertUtil.ToString(listInstoreType.EditValue);
