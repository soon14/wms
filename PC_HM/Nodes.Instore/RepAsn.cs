...
{
    public partial class RepAsn : DevExpress.XtraReports.UI.XtraReport
    {
        public readonly string RepFileName = "RepAsn.repx";
            ...
            try
            {
                ...
                foreach (JsonBillsResult jbr in bill.result)
                {
                    ...
                    catch (Exception msg)
                    {
                        ...
                        //LogHelper.errorLog("RepAsn+GetBillHeader", msg);
                    }
                    #endregion
        ...
        private void RepAsn_AfterPrint(object sender, EventArgs e)
        {
            ...
            //new BillLogDal().SavePrintLog(header.BillNO, pageCount, "打印采购入库单", GlobeSettings.LoginedUser.UserName);
        }
    }
}
