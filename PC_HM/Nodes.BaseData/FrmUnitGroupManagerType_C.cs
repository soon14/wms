...
{
    public partial class FrmUnitGroupManagerType_C : DevExpress.XtraEditors.XtraForm
    {
        private UnitGroupDal unitGrpDal = null;
        public FrmUnitGroupManagerType_C()
        {
            InitializeComponent();
        }
        ...
        {
            FrmUnitGroupEditType_C frmUnitGroupEdit = new FrmUnitGroupEditType_C();
        ...
        private void labCur_Click(object sender, EventArgs e)
        {

        }

        private void labYE_Click(object sender, EventArgs e)
        {

        }

        private void txtCountPage_TextChanged(object sender, EventArgs e)
        {

        }

        private void labZG_Click(object sender, EventArgs e)
        {

        }

        private void txtCurePage_TextChanged(object sender, EventArgs e)
        {
        ...
        private void textBoxDump_KeyPress(object sender, KeyPressEventArgs e)
        {
