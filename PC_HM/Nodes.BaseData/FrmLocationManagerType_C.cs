...
{
    public partial class FrmLocationManagerType_C : DevExpress.XtraEditors.XtraForm
    {
        private LocationDal locationDal = null;
        public FrmLocationManagerType_C()
        {
            InitializeComponent();
        }
        ...
        ///</summary>
        ///<returns></returns>
        public List<LocationEntity> GetAllLocationC02()
        {
            ...
            try
            {
                ...
                string jsonQuery = WebWork.SendRequest(string.Empty, WebWork.URL_GetAllLocationC02);
                ...
                JsonGetAllLocationC02 bill = JsonConvert.DeserializeObject<JsonGetAllLocationC02>(jsonQuery);
                if (bill == null)
                {
                ...
                #region 赋值数据
                foreach (JsonGetAllLocationC02Result jbr in bill.result)
                {
        ...
        public void LoadDataAndBindGrid()
        {
            try
            {
                bindingSource1.DataSource = GetAllLocationC02();
            }
            catch (Exception ex)
            {
                MsgBox.Err(ex.Message);
        ...
        {
            FrmLocationEditType_C frmLocationEdit = new FrmLocationEditType_C();
        ...
        private void ShowEditLocation()
        {
            ...
            FrmLocationEditType_C frmLocationEdit = new FrmLocationEditType_C(editEntity);
